    ...
    internal static class Data
    {
        ...
        static Data()
        {
            ...
            EmpList = new List<Employee>()
            {
                ...
                new Employee(){ID = 5, Name = "Tessa", Gender = "Female",DOB=DateOnly.Parse("16-01-2002"), DeptId = 1},
                new Employee(){ID = 6, Name = "Salena Gomez", Gender = "Female",DOB=DateOnly.Parse("29-08-1965"), DeptId = 1},
                new Employee(){ID = 7, Name = "Enrich", Gender = "Female",DOB=DateOnly.Parse("31-03-1988"), DeptId = 3},
                new Employee(){ID = 8, Name = "Ema Watson", Gender = "Female",DOB=DateOnly.Parse("15-04-2006"), DeptId = 2},
                new Employee(){ID = 9, Name = "Charlie puth", Gender = "Male",DOB=DateOnly.Parse("13-08-1987"), DeptId = 6},
                new Employee(){ID = 10, Name = "Post malone", Gender = "Male",DOB=DateOnly.Parse("15-04-2006"), DeptId = 8}
            };
